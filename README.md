...
A simple game made by agj for the 2025 [Gleam Game Jam](https://gamejam.gleam.community/), under the theme “Lucy in the sky with diamonds”.

[**Play here ☁️**](https://agj.github.io/cielos/)

This game was written in the [Gleam](https://gleam.run/) programming language, using the [paint](https://adelhult.github.io/paint/) graphics library.
